...
import 'package:movie_app/screens/home/Widget/up_coming/up_coming_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget buildMenu(double sizeWidth, double sizeHeight) {
    return Padding(
          ...
          Container(
            decoration: BoxDecoration(
              ...
              gradient: LinearGradient(
                  ...
                  colors: [
                    const Color(0xff75D1DD).withOpacity(0.2),
                    const Color(0xff6B66A6).withOpacity(0.2)
                  ]),
            ),
            height: 50,
          ),
  ...
  Widget buildPageViewUpComing() {
    return const PageUpComingMovies();
  }
}
