...
class _BuildPageViewUpComingState extends State<BuildPageViewUpComing> {
  ...
  void initState() {
    super.initState();
    final postMdl =
        Provider.of<ListMovieUpComingProvider>(context, listen: false);
    postMdl.fetchInitialMovies();
  }

  @override
  Widget build(BuildContext context) {
    final postMdl = context.watch<ListMovieUpComingProvider>();
        ...
        : Container(
            ...
            child: Swiper(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return buildCardUpComing(context, index, postMdl);
                },
